...
1. 26岁的美国 OpenAI 公司前研究员苏奇尔·巴拉吉近期被发现在他位于旧金山的公寓内自杀身亡。巴拉吉大学就读于加州大学伯克利分校，主修计算机科学。2020年正式加入 OpenAI 担任研究员，先后参与了 GPT-4 预训练、ChatGPT 后预训练、o1 推理等技术研发。在巴拉吉为GPT-4收集互联网数据阶段，GPT-4 用几个月的时间分析了互联网上几乎所有英语文本。巴拉吉认为，这种做法违反了美国关于已发表作品的“合理使用”的法律。
